...
from learningapp.models import Course, ClassMaterial, Assignment, Users, StudentCourses, Quiz, Question, Option, Result
...
def view_materials(request, course_id):
    material_details = ClassMaterial.objects.filter(course_id_id=course_id)
    course_details = Course.objects.get(id=course_id)
